...
# === LOAD MODEL (Naive Bayes + IndoBERT) ===
...
# === HEADER ===
st.markdown("<h1 style='font-size:36px;'>Analisis Sentimen Penggemar Timnas Indonesia Era Shin Tae-yong</h1>", unsafe_allow_html=True)
st.markdown("---", unsafe_allow_html=True)

# === TUJUAN ===
st.markdown("<h2>🎯 Tujuan Analisis</h2>", unsafe_allow_html=True)
st.write("""
...
with col1:
    st.markdown("<h3>Wordcloud Komentar Positif</h3>", unsafe_allow_html=True)
...
# === PREDIKSI ===
st.markdown("<h2>💡 Prediksi Sentimen Komentar</h2>", unsafe_allow_html=True)
...
# === KESIMPULAN ===
st.markdown("<h2>📝 Kesimpulan</h2>", unsafe_allow_html=True)
st.write("""
...
Penggunaan model berbasis Transformer dapat memahami konteks komentar dengan lebih baik 
dan menghasilkan analisis sentimen yang lebih akurat.
""")
